        ...
        <table className="min-w-full divide-y-2 divide-gray-200">
            ...
            <tbody className="divide-y divide-gray-200 *:even:bg-gray-50">
                ...
                { applications.map((application) => (
                    <tr className="*:text-gray-900 *:first:font-medium" key={ application.id }>
                        <td className="px-3 py-2 whitespace-nowrap">{ application.applicantName }</td>
                        <td className="px-3 py-2 whitespace-nowrap">{ application.subjectName }</td>
                        <td className="px-3 py-2 whitespace-nowrap hover:text-blue-300 underline cursor-pointer" onClick={() => seeApplicationDetails(application.id)}> Ver </td>
                    </tr>
                ))}
