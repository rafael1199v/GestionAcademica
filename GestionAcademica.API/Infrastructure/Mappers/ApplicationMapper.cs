...
public class ApplicationMapper
{
    ...
    public static  ApplicationDTO ApplicationModelToApplicationDTO(Persistence.Models.Application application)
    {
    ...
    public static ApplicantDTO ApplicationModelToApplicantDTO(Persistence.Models.Application application)
    {
